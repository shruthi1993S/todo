                    ...
                    <div key={index} className='col-lg-4 mb-3'>
                        <div className='card'>
                            <div className='card-body'>
                                ...
                                <button className='btn btn-danger me-2' onClick={() => handleDeleteTodo(index)}>Delete</button>
                                <button className='btn btn-secondary ' onClick={() => handleEditTodo(index)}>Edit</button>
                            </div>
                        </div>
                    </div>
                ))}
